...
vai tentar inferir quais são os tipos de variáveis que foram passadas e a partir do tipo do dado que foi passado
se for um inteiro ele vai entrar em um case, e se for string ele vai entrar em outro.
Se for uma função ele vai entrar case, e assim a gente vai conseguir a partir de um switch selecionar os tipos do dado
